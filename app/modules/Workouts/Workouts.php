					...
					<div class="modal-content">
						...
						<?php
							...
							while($row = mysqli_fetch_array($resut_vodeos))
							{
								...
								<div style="width:180px;height:120px;border:1px solid silver;margin:10px;float:left;background-image:url('videosthumb/<?php echo $row['video_thumb_path'];?>');background-size: cover;">
								</div>
								</a>
								<?php
							}
