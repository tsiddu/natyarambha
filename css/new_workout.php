...
<div class="canvas" > 
  ...
  <div class="container create-new-wkout-strip"> <br>
    <hgroup>
      <h4 class="chead">Create New Workout</h4>
    </hgroup>
    <br>
    <div>
          ...
          <div id="error_message"></div>
            <fieldset>
              ...
              <div class="form-group">
                ...
                <div class="col-md-4">
                  <input id="workout-name" name="workout-name" type="text" placeholder="Enter workout name" class="form-control" required >
                </div>
              </div>
              ...
              <div class="form-group">
                ...
                <div class="col-md-4">
                  <textarea class="form-control" id="message" name="message" placeholder="Enter a short description for the workout" rows="2" required ></textarea>
                </div>
              </div>
              <div class="form-group">
 ...
 <div class="container" id="extvid">
    <h2 class="chead"><span > Existing Videos</span></h2>
  ...
  ?>
    ...
    <div id="no_vid_message"><p>No Videos Selected</p></div>
    <div class="clearfix"></div>
 ...
 <h4 class="chead"><span >All Videos</span></h4>
  ...
  ?>
    ...
    <h4 class="chead"><span class="head-bg"><?php echo $lesson_row['lessons_name']; ?></span></h4>
	...
	?>
      ...
      <li class="col-lg-3 col-sm-4 col-xs-6" id="select_<?php echo $row['video_id']; ?>">
       ...
       <div style="height:30px;"> <?php echo $row['short_desc'];?></div>
	   <span class="duration"><?php list($mins , $secs) = explode('.' ,$row['video_duration']); echo $mins.":".$secs; ?></span>
        <button type="button" class="btn btn-default pull-left addto-workout" id="<?php echo $row['video_id']; ?>" style="margin-left:0px !important;"> Add to workout </button>
