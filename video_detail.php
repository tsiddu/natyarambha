...
<div class="canvas video-detail2" > 
  ...
  <div class="container lessons video-detail"> <br>
    ...
    <li class="col-sm-5 col-xs-12 vid-det-cont" style="display:none;" >
    ...
    <ul class="list-unstyled video-list-thumbs strip-video">
      ...
      <li class="col-lg-2 col-sm-4 col-xs-6 " > <a href="video_detail.php?lessons_id=<?php echo $lessons_id; ?>&video_id=<?php echo $video_full_data[$list_i]['id'] ?>"  title="<?php echo $video_full_data[$list_i]['video_name']; ?>"> <img src="app/videosthumb/<?php echo $video_full_data[$list_i]['video_thumb']; ?>" alt="Video" class="img-responsive" />
